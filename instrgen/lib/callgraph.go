...
func genTableEpilogue(out *os.File) {
	...
	out.WriteString("\n&nbsp;<input type=\"text\" id=\"buildargs\" name=\"Build cmd\" value=\"go build .\" required size=\"40\">")
	out.WriteString("\n&nbsp;<button id=\"build\" type=\"button\" onclick=\"build_clicked(this.id, buildargs.value)\">Build</button><br><br>")
	out.WriteString("\n&nbsp;&nbsp;<label for=\"envvarslabel\">Start settings</label><br><br>")
	out.WriteString("\n&nbsp;&nbsp;<label for=\"otelservicenamelabel\">OTEL_SERVICE_NAME:</label>")
	out.WriteString("\n&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" id=\"otelservicename\" name=\"otelservicename\" value=\"instrgen\" required size=\"40\"><br><br>")
	out.WriteString("\n&nbsp;&nbsp;<label for=\"oteltracesexporterlabel\">OTEL_TRACES_EXPORTER:</label>")
	out.WriteString("\n&nbsp;<input type=\"text\" id=\"oteltracesexporter\" name=\"oteltracesexporter\" value=\"otlp\" required size=\"40\"><br><br>")
	out.WriteString("\n&nbsp;&nbsp;<label for=\"otelexporterendpointlabel\">OTEL_EXPORTER_OTLP_ENDPOINT:</label>")
	out.WriteString("\n&nbsp;&nbsp;<input type=\"text\" id=\"otelexporterendpoint\" name=\"otelexporterendpoint\" value=\"localhost:4317\" required size=\"28\"><br><br>")
	out.WriteString("\n&nbsp;&nbsp;<label for=\"zipkinexporterendpointlabel\">OTEL_EXPORTER_ZIPKIN_ENDPOINT:</label>")
	out.WriteString("\n<input type=\"text\" id=\"zipkinexporterendpoint\" name=\"zipkinexporterendpoint\" value=\"http://localhost:9411/api/v2/spans\" required size=\"28\"><br><br>")
